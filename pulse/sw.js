const CACHE = 'pulse-v1.3.1';
const APP_SHELL = ['./', './index.html', './styles.css?v=1.3.1', './app.js?v=1.3.1', './loans.js?v=1.3.1', './vendor/supabase-2.45.4.js', './manifest.webmanifest?v=1.3.1', './icon.svg?v=1.3.1', './apple-touch-icon-v2.png', './icon-192-v2.png', './icon-512-v2.png'];
